  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans text-gray-800">
      ...
      <aside
        ...
        } bg-white border-r border-gray-200 flex flex-col justify-between z-30 transform transition-all duration-200 ease-in-out md:relative md:translate-x-0 ${
      ...
      <div className="flex-1 flex flex-col overflow-hidden w-full">
        ...
        <header className="bg-white h-16 border-b border-gray-200 flex items-center justify-between px-4 md:px-8 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div className="md:hidden font-bold text-blue-900 text-lg">
              MANOVATE
            </div>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div className="group relative flex items-center gap-2 cursor-pointer">
              ...
              {/* Dropdown for Logout */}
              <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
